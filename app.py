...
if st.button('Plot Group Graphs'):
    ...
    group_plot().plot(userValues,userValue,uniteType_Oil,graphNum,dfMultOil,final_directory,df_new,dft_new,answer,csumNames,mcolors,df_newcSUM,dftt_newcSUM,yearsx)
    #===============================================================================================================================================================#
